...
export default function Package() {
  ...
  const sliderParams = {      //learn more about this gg react-multi-carousel
      ...
      <Container>
        ...
        <Flex sx={styles.buttonGroup}>
          <Box sx={styles.buttonGroupInner}>
            ...
            type="button"
            aria-label="Monthly"
            onClick={()=>handlePricingPlan('monthly')}>Monthly Plan</button> 

            <button className={state.active === 'annual' ? 'active' : ''} 
            type="button"
            aria-label="Annual"
            onClick={()=>handlePricingPlan('annual')}>Annual Plan</button> 
          </Box>
        </Flex>
