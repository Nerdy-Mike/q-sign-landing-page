...
import icon1 from 'assets/icon/service-1-1.svg';
import icon2 from 'assets/icon/service-1-2.svg';
import icon3 from 'assets/icon/service-1-3.svg';
import icon4 from 'assets/icon/service-1-4.svg';
...
const SERVICES_DATA = [
  ...
  {
    icon: icon2,
    title: 'Public and Private Sharing mode',
    text:
      'Get your blood tests delivered at home collect a sample from the your blood tests.',
  },
  {
  ...
  {
    icon: icon4,
    title: 'Improve your company efficiency',
    text:
      'Get your blood tests delivered at home collect a sample from the your blood tests.',
  },
];
    ...
    <Box sx={styles.services} id="features">
      <Container>
        <BlockTitle
          ...
          title="Meet exciting features of app"
...
const styles = {
  services: {
    pt: ['80px', null, null, null, null, null, '80px'],
    pb: '70px',
