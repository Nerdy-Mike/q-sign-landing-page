...
export default function PriceCard({
  ...
  return (
    <Card className={header ? 'package__card active': 'package__card'} sx={styles.pricingBox}>
      ...
      {anotherOption && (<Button variant='textButton' className='free__trial' aria-label={anotherOption} sx={{color: 'black'}}>
        {anotherOption}
        </Button>)}
        </Box>
      </Box>
...
// className is added for debugging purposes, because nextjs use random name like : css-dm8ii1
const styles = {
  pricingBox: {
    borderRadius: 20,
    position: 'relative',
